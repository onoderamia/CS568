      ...
      <div className="result-card">
        ...
        <div className="result-section">
          <p className="feedback-text">
            This prompt was generated from your task or idea using the base SmolLM model endpoint.
          </p>
        </div>
      </div>
    </div>
...
function Message({ msg }) {
  ...
  if (msg.type === "task_prompt") return <TaskPromptResult msg={msg} />;
  return (
    <div className="message assistant">
      <div
...
const WELCOME = {
  ...
  taskPrompt:
    "Describe a task, project idea, or use case and I'll turn it into a polished prompt using a dedicated base-model endpoint.",
};

const INIT_MESSAGES = {
  check: [{ role: "assistant", type: "welcome", content: WELCOME.check }],
  generate: [{ role: "assistant", type: "welcome", content: WELCOME.generate }],
  taskPrompt: [{ role: "assistant", type: "welcome", content: WELCOME.taskPrompt }],
};
...
export default function App() {
  ...
  const [taskPromptMessages, setTaskPromptMessages] = useState(
    INIT_MESSAGES.taskPrompt,
  );
    ...
    <div className="app">
      <header className="header">
        ...
        <nav className="mode-toggle">
          ...
          <button
            className={`mode-btn ${mode === "taskPrompt" ? "active" : ""}`}
            onClick={() => switchMode("taskPrompt")}
          >
            Prompt from Idea
          </button>
        </nav>
              ...
              placeholder={
                mode === "check"
                  ...
                  : mode === "generate"
                    ...
                    : "Describe the task, project idea, or use case…"
              }
              value={input}
          ...
          <p className="hint">
            {mode === "check"
              ...
              : mode === "generate"
                ...
                : "Shift+Enter for new line · Prompt from Idea mode"}
          </p>
        </div>
      ) : null}
    </div>
